...
meta_sim <- matrix(0, nrow = 35, ncol = 3)
simulated2 <- matrix(NA, nrow = 35, ncol = length(chosen_taxa))
# use majority vote to get the meta_data
for(i in 1:length(chosen_taxa)){
  j = chosen_taxa[i]
  counts <- real_data[,j]
  sample_idx <- sample(which(counts > log10(1.01) + 1e-6), 35)
...
write.csv(sim_tab_zi_trans, "Health_CA_zero_1.csv")
simulated2_trans <-t(10^(simulated2) - 1.01)
write.csv(simulated2_trans, "Health_CA_full_1.csv")
...
for (i in 1:dim(data_full_eval)[1]) {
    spearman_coefficient_sum <- spearman_coefficient_sum + cor(data_full_eval[i,], mbimpute_mat[i,], method="spearman")
}
spearman_coefficient_mean <- spearman_coefficient_sum / dim(data_full_eval)[1]
cat(sprintf("mse=%f \n", mse))
cat(sprintf("spearman=%f \n", spearman_coefficient_mean))
...
spearman_coefficient_sum <- 0
for (i in 1:dim(data_full_eval)[1]) {
    spearman_coefficient_sum <- spearman_coefficient_sum + cor(data_full_eval[i,], data_zero[i,],method="spearman")
}
spearman_coefficient_mean <- spearman_coefficient_sum / dim(data_full_eval)[1]
cat(sprintf("mse=%f \n", mse))
cat(sprintf("spearman=%f \n", spearman_coefficient_mean))
...
spearman_coefficient_sum <- 0                                  
for (i in 1:dim(data_full_eval)[1]) {
    spearman_coefficient_sum <- spearman_coefficient_sum + cor(data_full_eval[i,], saver_mat_eval[i,], method="spearman")
}
spearman_coefficient_mean <- spearman_coefficient_sum / dim(data_full_eval)[1]
cat(sprintf("mse=%f \n", mse))
cat(sprintf("spearman=%f \n", spearman_coefficient_mean))
...
data_full_eval <- data_full_eval / scale
data_full_eval <- log10(data_full_eval + 1)
GEImpute <- t(read.csv("geimpute_Health_CA_impute_1.csv", row.names = "X"))
...
spearman_coefficient_sum <- 0                                  
for (i in 1:dim(data_full_eval)[1]) {
    spearman_coefficient_sum <- spearman_coefficient_sum + cor(data_full_eval[i,], GEImpute[i,], method="spearman")
}
spearman_coefficient_mean <- spearman_coefficient_sum / dim(data_full_eval)[1]
cat(sprintf("mse=%f \n", mse))
cat(sprintf("spearman=%f \n", spearman_coefficient_mean))
...
data_full_eval <- data_full_eval / scale
data_full_eval <- log10(data_full_eval + 1)
mbSparseImpute <- t(read.csv("Health_CA_impute_normalize_1.csv", row.names = "X"))
size <- dim(data_full_eval)[1] * dim(data_full_eval)[2] 
...
spearman_coefficient_sum <- 0                                  
for (i in 1:dim(data_full_eval)[1]) {
    spearman_coefficient_sum <- spearman_coefficient_sum + cor(data_full_eval[i,], softImpute[i,], method="spearman")
}
spearman_coefficient_mean <- spearman_coefficient_sum / dim(data_full_eval)[1]
cat(sprintf("mse=%f \n", mse))
cat(sprintf("spearman=%f \n", spearman_coefficient_mean))
